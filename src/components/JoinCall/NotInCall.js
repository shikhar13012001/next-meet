    ...
    <div className="p-8 h-full">
      <div className="max-w-[700px] m-auto h-full flex flex-col items-center justify-between">
        ...
        <div className="w-full">
          ...
          <Typography variant="body1" component="div" sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>share the meet-code <QR url={id} /></Typography>

          <Typography variant="subtitle1" color="GrayText">{id}</Typography>
        </div>
        {/* Number of people in the meet */}
         
        <div className="text-xl font-semibold">
          {presentUsers.length} people are in the call
        </div>
        {/* Join */}
