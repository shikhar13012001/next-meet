...
export default function BasicModal({url}) {
  ...
  return (
    <div>
      <Button onClick={handleOpen}><BsFillShareFill size={24} /></Button>
      <Modal
        open={open}
        onClose={handleClose}
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }} variant="body1">
            ...
            */}
            <Box sx={{width:'100%',display:'flex',justifyContent:'center',alignItems:'center',gap:2}}>
                ...
                <Typography variant='h6' sx={{mt:2,textAlign:'center'}}>Share on</Typography>
            <Box sx={{width:'100%',mt:3,display:'flex',justifyContent:'center',alignItems:'center',gap:2}}>
